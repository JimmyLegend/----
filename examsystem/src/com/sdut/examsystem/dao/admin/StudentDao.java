...
public class StudentDao implements IStudentDao {
	...
	public List<Map<String, Object>> findAll() {
		...
		try {
			list = db.getQueryList("select st.id,st.name,st.sex,st.born,st.pwd,st.school,st.deptName,sc.name className from student st,stuclass sc where st.classId=sc.id order by id");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

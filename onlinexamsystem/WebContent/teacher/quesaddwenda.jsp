...
<body>
	<div class="text2">
		<form id="form1" name="form1" method="post"
			action="QuestionAddWenDaServlet" onsubmit="return verInput();">
          ...
          <option value="3">判断对错</option> -->
				...
				<tr>
					<td valign="top">题目：</td>
					<td><label> <textarea id="queTitle" name="queTitle" cols="100" rows="5" style="width:750px;height:260px;visibility:hidden;float:left;">${testQuestions.paperTitle}</textarea>
					</label></td>
				...
				<tr>
					...
					<td><label> 
					<textarea id="ans" name="ans" cols="100" rows="5" style="width:750px;height:260px;visibility:hidden;float:left;">${testQuestions.paperTitle}</textarea>
					</label></td>
